...
<br/>
![Loading Data into New Partition While API Still Uses Old One](https://github.com/AlexCue987/talking-the-talk/blob/main/postgres/upload-to-new-partition.png?raw=true)
